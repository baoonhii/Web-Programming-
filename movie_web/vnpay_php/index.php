                ...
                <form action="vnpay_create_payment.php" id="create_form" method="post">       
                    ...
                    <div class="form-group">
                        ...
                        <select name="order_type" id="order_type" class="form-control">
                            <option value="topup">Thanh toan hoa don</option>
                        </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <?php
                            $textBoxValue = $_REQUEST['total_amount'];
                        ?>
                        <input class="form-control" id="amount"
                               name="amount" type="number" value="<?php echo $textBoxValue?>"/>
                    </div>
                    <div class="form-group">
                        <label for="order_desc">Nội dung thanh toán</label>
                        <?php 
                            $contentbox = $_REQUEST['user_content']
                        ?>
                        <textarea class="form-control" cols="20" id="order_desc" name="order_desc" rows="2"><?php echo $contentbox?></textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label >Họ tên (*)</label>
                        <?php
                            $textBoxValue1 = $_REQUEST['user_name'];
                        ?>
                        <input class="form-control" id="txt_billing_fullname"
                               name="txt_billing_fullname" type="text" value="<?php echo $textBoxValue1?>"/>             
                    </div>
                    <div class="form-group">
                        <label >Email (*)</label>
                        <?php
                            $textBoxValue2 = $_REQUEST['user_email'];
                        ?>
                        <input class="form-control" id="txt_billing_email"
                               name="txt_billing_email" type="text" value="<?php echo $textBoxValue2?>"/>   
                    </div>
                    <div class="form-group">
                        <label >Số điện thoại (*)</label>
                        <?php
                            $textBoxValue3 = $_REQUEST['user_phone'];
                        ?>
                        <input class="form-control" id="txt_billing_mobile"
                               name="txt_billing_mobile" type="text" value="<?php echo $textBoxValue3?>"/>   
                    </div>
                    <div class="form-group">
                        <label >Địa chỉ (*)</label>
                        <?php
                            $textBoxValue4 = $_REQUEST['user_address'];
                        ?>
                        <input class="form-control" id="txt_billing_addr1"
                               name="txt_billing_addr1" type="text" value="<?php echo $textBoxValue4?>"/>   
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="txt_bill_city"
                               name="txt_bill_city" type="text" value="<?php echo $textBoxValue4?>"/> 
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="txt_ship_fullname"
                               name="txt_ship_fullname" type="text" value="<?php echo $textBoxValue1?>"/>
                    </div>
                    <div class="form-group">
                        <label >Email (*)</label>
                        <input class="form-control" id="txt_ship_email"
                               name="txt_ship_email" type="text" value="<?php echo $textBoxValue2?>"/>
                    </div>
                    <div class="form-group">
                        <label >Số điện thoại (*)</label>
                        <input class="form-control" id="txt_ship_mobile"
                               name="txt_ship_mobile" type="text" value="<?php echo $textBoxValue3?>"/>
                    </div>
                    <div class="form-group">
                        <label >Địa chỉ (*)</label>
                        <input class="form-control" id="txt_ship_addr1"
                               name="txt_ship_addr1" type="text" value="<?php echo $textBoxValue4?>"/>
                    </div>
                    <div class="form-group">
                        <label >Mã bưu điện (*)</label>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="txt_ship_city"
                               name="txt_ship_city" type="text" value="<?php echo $textBoxValue4?>"/>
                    </div>
                    <div class="form-group">
                        <label>Bang (Áp dụng cho US,CA)</label>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="txt_inv_customer"
                               name="txt_inv_customer" type="text" value="<?php echo $textBoxValue1?>"/>
                    </div>
                    <div class="form-group">
                        <label >Công ty</label>
                        <input class="form-control" id="txt_inv_company"
                               name="txt_inv_company" type="text" value="No"/>
                    </div>
                    <div class="form-group">
                        <label >Địa chỉ</label>
                        <input class="form-control" id="txt_inv_addr1"
                               name="txt_inv_addr1" type="text" value="<?php echo $textBoxValue4?>"/>
                    </div>
                    <div class="form-group">
                        <label>Mã số thuế</label>
                        <input class="form-control" id="txt_inv_taxcode"
                               name="txt_inv_taxcode" type="text" value="No"/>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="txt_inv_email"
                               name="txt_inv_email" type="text" value="<?php echo $textBoxValue2?>"/>
                    </div>
                    <div class="form-group">
                        <label >Điện thoại</label>
                        <input class="form-control" id="txt_inv_mobile"
                               name="txt_inv_mobile" type="text" value="<?php echo $textBoxValue3?>"/>
                    </div>
