   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="password" name="update_pass" placeholder="Enter password" class="box">
            <span>New password:</span>
            <input type="password" name="new_pass" placeholder="Enter new password" class="box">
            <span>Confirm password:</span>
            <input type="password" name="confirm_pass" placeholder="Confirm password again" class="box">
         </div>
      </div>
      <div class="flex-btn">
